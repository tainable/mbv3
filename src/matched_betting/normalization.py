...
TEAM_ALIASES = {
    ...
    # FIFA World Cup team aliases — canonical names are plain ASCII (no accents).
    # Matchbook per-match events already use ASCII names ("Turkey" not "Turkiye"),
    # so few aliases are needed; mainly handle Curacao's accented char and any
    # hyphen/ampersand variants in multi-word names.
    "wc": {
        "curacao":                      "curacao",
        "cura ao":                      "curacao",
        "turkiye":                      "turkey",
    ...
    # wc_spread and wc_totals share the same team aliases as wc.
    "wc_spread": {
        "curacao":                      "curacao",
        "cura ao":                      "curacao",
        "turkiye":                      "turkey",
